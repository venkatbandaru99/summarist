...
function gb(e) {
    if ("number" != typeof e && e && !e.fa) {
        ...
        if (t && t[Q]) Ua(t.i, e);
            ...
            var n = e.type,
                i = e.proxy;
            t.removeEventListener ? t.removeEventListener(n, i, e.capture) : t.detachEvent ? t.detachEvent(db(n), i) : t.addListener && t.removeListener && t.removeListener(i), (n = bb(t)) ? (Ua(n, e), 0 == n.h && (n.src = null, t[W] = null)) : Ma(e)
        }
    }
}
        ...
        if (e == this.g) e: {
            ...
            if (!(3 > d) && (3 != d || N || this.g && (this.h.h || this.g.ja() || mc(this.g)))) {
                ...
                if (this.i = 200 == n, function Ib(e, t, n, i, s, o, u) {
                    ...
                    this.S ? (rc(this, d, u), N && this.i && 3 == d && (Eb(this.U, this.V, "tick", this.mb), this.V.start())) : (D$1(this.j, this.m, u, null), qc(this, u)), 4 == d && I(this), this.i && !this.J && (4 == d ? sc(this.l, this) : (this.i = !1, jc(this)))
                } else(function tc(e) {
                    const t = {};
...
function cd(e) {
    this.l = e || Ie, E.PerformanceNavigationTiming ? e = 0 < (e = E.performance.getEntriesByType("navigation")).length && ("hq" == e[0].nextHopProtocol || "h2" == e[0].nextHopProtocol) : e = !!(E.g && E.g.Ka && E.g.Ka() && E.g.Ka().dc), this.j = e ? this.l : 1, this.g = null, 1 < this.j && (this.g = new Set), this.h = null, this.i = []
}
var Ie = 10;
...
function md(e, t) {
    B$1.call(this), this.F = e, this.u = t, this.m = void 0, this.readyState = pe, this.status = 0, this.responseType = this.responseText = this.response = this.statusText = "", this.onreadystatechange = null, this.v = new Headers, this.h = null, this.C = "GET", this.B = "", this.g = !1, this.A = this.j = this.l = null
}
...
function od(e) {
    ...
    this.response = this.responseText = "", this.v = new Headers, this.status = 0, this.j && this.j.cancel("Request was aborted.").catch((() => {})), 1 <= this.readyState && this.g && 4 != this.readyState && (this.g = !1, pd(this)), this.readyState = pe
}, m.$a = function(e) {
...
class __PRIVATE_IndexBackfiller {
    ...
    ne(e, t) {
        ...
        return PersistencePromise.doWhile((() => !0 === s && i > 0), (() => this.localStore.indexManager.getNextCollectionGroupToUpdate(e).next((t => {
            if (null !== t && !n.has(t)) return __PRIVATE_logDebug("IndexBackiller", `Processing collection: ${t}`), this.re(e, t, i).next((e => {
                i -= e, n.add(t)
            }));
            s = !1
        })))).next((() => t - i))
    ...
    re(e, t, n) {
        return this.localStore.indexManager.getMinOffsetFromCollectionGroup(e, t).next((i => this.localStore.localDocuments.getNextDocuments(e, t, i, n).next((n => {
            const s = n.changes;
            return this.localStore.indexManager.updateIndexEntries(e, s).next((() => this.ie(i, n))).next((n => (__PRIVATE_logDebug("IndexBackiller", `Updating offset: ${n}`), this.localStore.indexManager.updateCollectionGroup(e, t, n)))).next((() => s.size))
        }))))
    }
    ie(e, t) {
        let n = e;
...
function __PRIVATE_toQueryTarget(e, t) {
    const n = {
        ...
        i = t.path;
    null !== t.collectionGroup ? (n.parent = __PRIVATE_toQueryPath(e, i), n.structuredQuery.from = [{
        collectionId: t.collectionGroup,
        allDescendants: !0
    }]) : (n.parent = __PRIVATE_toQueryPath(e, i.popLast()), n.structuredQuery.from = [{
    ...
    return null !== u && (n.structuredQuery.limit = u), t.startAt && (n.structuredQuery.startAt = function __PRIVATE_toStartAtCursor(e) {
        return {
            before: e.inclusive,
            values: e.position
        }
...
class __PRIVATE_FirestoreIndexValueWriter {
    ...
    ft(e, t) {
        this.Tt(t, 37), DocumentKey.fromName(e).path.forEach((e => {
...
class __PRIVATE_IndexedDbIndexManager {
    constructor(e, t) {
        this.user = e, this.databaseId = t, this._n = new __PRIVATE_MemoryCollectionParentIndex, this.an = new ObjectMap((e => __PRIVATE_canonifyTarget(e)), ((e, t) => __PRIVATE_targetEquals(e, t))), this.uid = e.uid || ""
    }
    addToCollectionParentIndex(e, t) {
        if (!this._n.has(t)) {
    ...
    un(e) {
        let t = this.an.get(e);
        return t || (t = 0 === e.filters.length ? [e] : __PRIVATE_getDnfTerms(CompositeFilter.create(e.filters, "and")).map((t => __PRIVATE_newTarget(e.path, e.collectionGroup, e.orderBy, t.getFilters(), e.limit, e.startAt, e.endAt))), this.an.set(e, t), t)
    }
    Pn(e, t, n, i, s, o, u) {
    ...
    getIndexType(e, t) {
        let n = 2;
        const i = this.un(t);
        return PersistencePromise.forEach(i, (t => this.cn(e, t).next((e => {
    ...
    updateIndexEntries(e, t) {
        ...
        return PersistencePromise.forEach(t, ((t, i) => {
            ...
            return (s ? PersistencePromise.resolve(s) : this.getFieldIndexes(e, t.collectionGroup)).next((s => (n.set(t.collectionGroup, s), PersistencePromise.forEach(s, (n => this.gn(e, t, n).next((t => {
                const s = this.pn(i, n);
    ...
    pn(e, t) {
        ...
        if (null != s) {
            ...
            if (isArray(o))
                for (const s of o.arrayValue.values || []) n = n.add(new __PRIVATE_IndexEntry(t.indexId, e.key, this.In(s), i))
...
class __PRIVATE_IndexedDbRemoteDocumentChangeBuffer extends RemoteDocumentChangeBuffer {
    constructor(e, t) {
        super(), this._r = e, this.trackRemovals = t, this.ar = new ObjectMap((e => e.toString()), ((e, t) => e.isEqual(t)))
    }
    applyChanges(e) {
        const t = [];
        let n = 0,
...
class __PRIVATE_MemoryBundleCache {
    ...
    saveBundleMetadata(e, t) {
        return this.ur.set(t.id, function __PRIVATE_fromBundleMetadata(e) {
            return {
                id: e.id,
                version: e.version,
...
class __PRIVATE_ReferenceSet {
    ...
    Rr(e) {
        const t = new DocumentKey(new ResourcePath([])),
            ...
            s = [];
        return this.Ir.forEachInRange([n, i], (e => {
...
class __PRIVATE_MemoryMutationQueue {
    ...
    getAllMutationBatchesAffectingDocumentKey(e, t) {
        const n = new __PRIVATE_DocReference(t, 0),
            ...
            s = [];
        return this.yr.forEachInRange([n, i], (e => {
    ...
    getAllMutationBatchesAffectingQuery(e, t) {
        ...
        }), o), PersistencePromise.resolve(this.br(u))
    }
    br(e) {
        const t = [];
        return e.forEach((e => {
...
class __PRIVATE_MemoryTargetCache {
    constructor(e) {
        this.persistence = e, this.Fr = new ObjectMap((e => __PRIVATE_canonifyTarget(e)), __PRIVATE_targetEquals), this.lastRemoteSnapshotVersion = SnapshotVersion.min(), this.highestTargetId = 0, this.Mr = 0, this.Or = new __PRIVATE_ReferenceSet, this.targetCount = 0, this.Nr = __PRIVATE_TargetIdGenerator.On()
    }
    forEachTarget(e, t) {
...
class __PRIVATE_MemoryPersistence {
    constructor(e, t) {
        this.Br = {}, this.overlays = {}, this.Lr = new __PRIVATE_ListenSequence(0), this.kr = !1, this.kr = !0, this.referenceDelegate = e(this), this.qr = new __PRIVATE_MemoryTargetCache(this), this.indexManager = new __PRIVATE_MemoryIndexManager, this.remoteDocumentCache = function __PRIVATE_newMemoryRemoteDocumentCache(e) {
    ...
    runTransaction(e, t, n) {
        ...
        return this.referenceDelegate.$r(), n(i).next((e => this.referenceDelegate.Ur(i).next((() => e)))).toPromise().then((e => (i.raiseOnCommittedEvent(), e)))
    }
    Wr(e, t) {
...
class __PRIVATE_MemoryLruDelegate {
    ...
    removeOrphanedDocuments(e, t) {
        ...
        const i = this.persistence.getRemoteDocumentCache(),
            s = i.newChangeBuffer();
        return i.vr(e, (i => this.Xn(e, i, t).next((e => {
...
class __PRIVATE_SchemaConverter {
    ...
    N(e, t, n, i) {
        ...
        }))), n < 5 && i >= 5 && (o = o.next((() => this.Zr(s)))), n < 6 && i >= 6 && (o = o.next((() => (function __PRIVATE_createDocumentGlobalStore(e) {
            e.createObjectStore("remoteDocumentGlobal")
        }(e), this.Xr(s))))), n < 7 && i >= 7 && (o = o.next((() => this.ei(s)))), n < 8 && i >= 8 && (o = o.next((() => this.ti(e, s)))), n < 9 && i >= 9 && (o = o.next((() => {
        ...
        }))), n < 10 && i >= 10 && (o = o.next((() => this.ni(s)))), n < 11 && i >= 11 && (o = o.next((() => {
        ...
        }(e))).next((() => this.ri(e, s))).next((() => e.deleteObjectStore("remoteDocuments")))), n < 14 && i >= 14 && (o = o.next((() => this.ii(e, s)))), n < 15 && i >= 15 && (o = o.next((() => function __PRIVATE_createFieldIndex(e) {
...
class __PRIVATE_IndexedDbPersistence {
    constructor(e, t, n, i, s, o, u, l, _, h, d = 15) {
        if (this.allowTabSynchronization = e, this.persistenceKey = t, this.clientId = n, this.si = s, this.window = o, this.document = u, this.oi = _, this._i = h, this.ai = d, this.Lr = null, this.kr = !1, this.isPrimary = !1, this.networkEnabled = !0, this.ui = null, this.inForeground = !1, this.ci = null, this.li = null, this.hi = Number.NEGATIVE_INFINITY, this.Pi = e => Promise.resolve(), !__PRIVATE_IndexedDbPersistence.D()) throw new FirestoreError($e.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
        this.referenceDelegate = new __PRIVATE_IndexedDbLruDelegateImpl(this, i), this.Ii = t + "main", this.serializer = new __PRIVATE_LocalSerializer(l), this.Ti = new __PRIVATE_SimpleDb(this.Ii, this.ai, new __PRIVATE_SchemaConverter(this.serializer)), this.qr = new __PRIVATE_IndexedDbTargetCache(this.referenceDelegate, this.serializer), this.remoteDocumentCache = __PRIVATE_newIndexedDbRemoteDocumentCache(this.serializer), this.Kr = new __PRIVATE_IndexedDbBundleCache, this.window && this.window.localStorage ? this.Ei = this.window.localStorage : (this.Ei = null, !1 === h && __PRIVATE_logError("IndexedDbPersistence", "LocalStorage is unavailable. As a result, persistence may not work reliably. In particular enablePersistence() could fail immediately after refreshing the page."))
    }
    start() {
        return this.di().then((() => {
    ...
    async bi() {
        if (this.isPrimary && !this.Di(this.hi, 18e5)) {
            ...
            if (this.Ei)
                for (const t of e) this.Ei.removeItem(this.vi(t.clientId))
        }
    }
    Vi() {
    ...
    gi(e) {
        return this._i ? PersistencePromise.resolve(!0) : __PRIVATE_primaryClientStore(e).get("owner").next((t => {
    ...
    runTransaction(e, t, n) {
        ...
        let o;
        return this.Ti.runTransaction(e, i, s, (i => (o = new __PRIVATE_IndexedDbTransaction(i, this.Lr ? this.Lr.next() : __PRIVATE_ListenSequence._e), "readwrite-primary" === t ? this.fi(o).next((e => !!e || this.gi(o))).next((t => {
            ...
            return n(o)
        })).next((e => this.yi(o).next((() => e)))) : this.Li(o).next((() => n(o)))))).then((e => (o.raiseOnCommittedEvent(), e)))
    }
    Li(e) {
...
class __PRIVATE_QueryEngine {
    ...
    getDocumentsMatchingQuery(e, t, n, i) {
        ...
        return this.zi(e, t).next((e => {
            ...
            if (!s.result) return this.ji(e, t, i, n).next((e => {
                s.result = e
            }))
        })).next((() => {
            if (s.result) return;
    ...
    zi(e, t) {
        ...
        return this.indexManager.getIndexType(e, n).next((i => 0 === i ? null : (null !== t.limit && 1 === i && (t = __PRIVATE_queryWithLimit(t, null, "F"), n = __PRIVATE_queryToTarget(t)), this.indexManager.getDocumentsMatchingTarget(e, n).next((i => {
            ...
            return this.Gi.getDocuments(e, s).next((i => this.indexManager.getMinOffset(e, n).next((n => {
                const o = this.Yi(t, i);
    ...
    ji(e, t, n, i) {
        return __PRIVATE_queryMatchesAllDocuments(t) || i.isEqual(SnapshotVersion.min()) ? PersistencePromise.resolve(null) : this.Gi.getDocuments(e, n).next((s => {
            const o = this.Yi(t, s);
            return this.Zi(t, o, n, i) ? PersistencePromise.resolve(null) : (__PRIVATE_getLogLevel() <= l.DEBUG && __PRIVATE_logDebug("QueryEngine", "Re-using previous result from %s to execute query: %s", i.toString(), __PRIVATE_stringifyQuery(t)), this.Xi(e, o, t, __PRIVATE_newIndexOffsetSuccessorFromReadTime(i, -1)).next((e => e)))
        }))
    }
    Yi(e, t) {
    ...
    Xi(e, t, n, i) {
        return this.Gi.getDocumentsMatchingQuery(e, n, i).next((e => (t.forEach((t => {
            e = e.insert(t.key, t)
        })), e)))
    }
}
class __PRIVATE_LocalStoreImpl {
    constructor(e, t, n, i) {
        this.persistence = e, this.es = t, this.serializer = i, this.ts = new SortedMap(__PRIVATE_primitiveComparator), this.ns = new ObjectMap((e => __PRIVATE_canonifyTarget(e)), __PRIVATE_targetEquals), this.rs = new Map, this.ss = e.getRemoteDocumentCache(), this.qr = e.getTargetCache(), this.Kr = e.getBundleCache(), this.os(n)
    }
    os(e) {
...
async function __PRIVATE_localStoreHandleUserChange(e, t) {
    ...
    return await n.persistence.runTransaction("Handle user change", "readonly", (e => {
        let i;
        return n.mutationQueue.getAllMutationBatches(e).next((s => (i = s, n.os(t), n.mutationQueue.getAllMutationBatches(e)))).next((t => {
            const s = [],
                o = [];
...
function __PRIVATE_localStoreExecuteQuery(e, t, n) {
    ...
    })).next((() => i.es.getDocumentsMatchingQuery(e, t, n ? s : SnapshotVersion.min(), n ? o : __PRIVATE_documentKeySet()))).next((e => (__PRIVATE_setMaxReadTime(i, __PRIVATE_queryCollectionGroup(t), e), {
        documents: e,
        ls: o
    })))))
}
...
function __PRIVATE_localStoreGetNewDocumentChanges(e, t) {
    ...
    return n.persistence.runTransaction("Get new document changes", "readonly", (e => n.ss.getAllFromCollectionGroup(e, t, __PRIVATE_newIndexOffsetSuccessorFromReadTime(i, -1), Number.MAX_SAFE_INTEGER))).then((e => (__PRIVATE_setMaxReadTime(n, t, e), e)))
}
...
async function __PRIVATE_localStoreSaveNamedQuery(e, t, n = __PRIVATE_documentKeySet()) {
    ...
    return s.persistence.runTransaction("Save named query", "readwrite", (e => {
        ...
        return s.ts = s.ts.insert(u.targetId, u), s.qr.updateTargetData(e, u).next((() => s.qr.removeMatchingKeysForTargetId(e, i.targetId))).next((() => s.qr.addMatchingKeys(e, n, i.targetId))).next((() => s.Kr.saveNamedQuery(e, t)))
    }))
}
...
class __PRIVATE_WebStorageSharedClientState {
    constructor(e, t, n, i, s) {
        this.window = e, this.si = t, this.persistenceKey = n, this.Rs = i, this.syncEngine = null, this.onlineStateHandler = null, this.sequenceNumberHandler = null, this.Vs = this.fs.bind(this), this.gs = new SortedMap(__PRIVATE_primitiveComparator), this.started = !1, this.ps = [];
        const o = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
        this.storage = this.window.localStorage, this.currentUser = s, this.ys = createWebStorageClientStateKey(this.persistenceKey, this.Rs), this.ws = function createWebStorageSequenceNumberKey(e) {
            return `firestore_sequence_number_${e}`
        }(this.persistenceKey), this.gs = this.gs.insert(this.Rs, new __PRIVATE_LocalClientState), this.Ss = new RegExp(`^firestore_clients_${o}_([^_]*)$`), this.bs = new RegExp(`^firestore_mutations_${o}_(\\d+)(?:_(.*))?$`), this.Ds = new RegExp(`^firestore_targets_${o}_(\\d+)$`), this.Cs = function createWebStorageOnlineStateKey(e) {
...
class __PRIVATE_WebChannelConnection extends class __PRIVATE_RestConnection {
    ...
    wo(e, t, n, i, s) {
        ...
        return this.bo(l, i, s), this.Do(e, u, l, n).then((t => (__PRIVATE_logDebug("RestConnection", `Received RPC '${e}' ${o}: `, t), t)), (t => {
    ...
    vo(e, t, n) {
        ...
        return __PRIVATE_unguardedEventListen(d, Me.EventType.OPEN, (() => {
...
class __PRIVATE_ExponentialBackoff {
    ...
    ko(e) {
        ...
        const t = Math.floor(this.Oo + this.qo()),
            ...
            i = Math.max(0, t - n);
        i > 0 && __PRIVATE_logDebug("ExponentialBackoff", `Backing off for ${i} ms (base delay: ${this.Oo} ms, delay with jitter: ${t} ms, last attempt: ${n} ms ago)`), this.No = this.si.enqueueAfterDelay(this.timerId, i, (() => (this.Bo = Date.now(), e()))), this.Oo *= this.Mo, this.Oo < this.Fo && (this.Oo = this.Fo), this.Oo > this.xo && (this.Oo = this.xo)
    }
    Qo() {
...
class __PRIVATE_PersistentStream {
    constructor(e, t, n, i, s, o, u, l) {
        this.si = e, this.Ko = n, this.$o = i, this.connection = s, this.authCredentialsProvider = o, this.appCheckCredentialsProvider = u, this.listener = l, this.state = 0, this.Uo = 0, this.Wo = null, this.Go = null, this.stream = null, this.zo = new __PRIVATE_ExponentialBackoff(e, t)
    }
    jo() {
...
class __PRIVATE_DatastoreImpl extends class Datastore {} {
    ...
    wo(e, t, n) {
        return this.A_(), Promise.all([this.authCredentials.getToken(), this.appCheckCredentials.getToken()]).then((([i, s]) => this.connection.wo(e, t, n, i, s))).catch((e => {
    ...
    Co(e, t, n, i) {
        return this.A_(), Promise.all([this.authCredentials.getToken(), this.appCheckCredentials.getToken()]).then((([s, o]) => this.connection.Co(e, t, n, s, o, i))).catch((e => {
            throw "FirebaseError" === e.name ? (e.code === $e.UNAUTHENTICATED && (this.authCredentials.invalidateToken(), this.appCheckCredentials.invalidateToken()), e) : new FirestoreError($e.UNKNOWN, e.toString())
        }))
    }
    terminate() {
...
class __PRIVATE_RemoteStoreImpl {
    constructor(e, t, n, i, s) {
        this.localStore = e, this.datastore = t, this.asyncQueue = n, this.remoteSyncer = {}, this.b_ = [], this.D_ = new Map, this.C_ = new Set, this.v_ = [], this.F_ = s, this.F_.ro((e => {
...
async function __PRIVATE_onWriteStreamClose(e, t) {
    t && __PRIVATE_ensureWriteStream(e).h_ && await async function __PRIVATE_handleWriteError(e, t) {
...
function __PRIVATE_ensureWatchStream(e) {
    return e.O_ || (e.O_ = function __PRIVATE_newPersistentWatchStream(e, t, n) {
        const i = __PRIVATE_debugCast(e);
...
function __PRIVATE_ensureWriteStream(e) {
    return e.N_ || (e.N_ = function __PRIVATE_newPersistentWriteStream(e, t, n) {
        const i = __PRIVATE_debugCast(e);
...
class __PRIVATE_BundleLoader {
    ...
    async complete() {
        const e = await async function __PRIVATE_localStoreApplyBundledDocuments(e, t, n, i) {
            ...
            return s.persistence.runTransaction("Apply bundle documents", "readwrite", (e => __PRIVATE_populateDocumentChangeBuffer(e, l, u).next((t => (l.apply(e), t))).next((t => s.qr.removeMatchingKeysForTargetId(e, _.targetId).next((() => s.qr.addMatchingKeys(e, o, _.targetId))).next((() => s.localDocuments.getLocalViewOfDocuments(e, t.us, t.cs))).next((() => t.us))))))
        }(this.localStore, new __PRIVATE_BundleConverterImpl(this.serializer), this.documents, this.X_.id), t = this.ta(this.documents);
...
class __PRIVATE_View {
    constructor(e, t) {
        this.query = e, this.ia = t, this.sa = null, this.hasCachedResults = !1, this.current = !1, this.oa = __PRIVATE_documentKeySet(), this.mutatedKeys = __PRIVATE_documentKeySet(), this._a = __PRIVATE_newQueryComparator(e), this.aa = new DocumentSet(this._a)
    }
    get ua() {
        return this.ia
    }
    ca(e, t) {
        ...
        if (e.inorderTraversal(((e, t) => {
                ...
                h && d ? h.data.isEqual(d.data) ? m !== f && (n.track({
                    type: 3,
                    doc: d
                }), g = !0) : this.ha(h, d) || (n.track({
                    type: 2,
                    doc: d
                }), g = !0, (l && this._a(d, l) > 0 || _ && this._a(d, _) < 0) && (u = !0)) : !h && d ? (n.track({
                    type: 0,
                    doc: d
                }), g = !0) : h && !d && (n.track({
                    type: 1,
    ...
    applyChanges(e, t, n, i) {
        ...
        }(e.type, t.type) || this._a(e.doc, t.doc))), this.Pa(n), i = null != i && i;
        const u = t && !i ? this.Ia() : [],
            l = 0 === this.oa.size && this.current && !i ? 1 : 0,
            _ = l !== this.sa;
        return this.sa = l, 0 !== o.length || _ ? {
            snapshot: new ViewSnapshot(this.query, e.aa, s, o, e.mutatedKeys, 0 === l, _, !1, !!n && n.resumeToken.approximateByteSize() > 0),
            Ta: u
        } : {
            Ta: u
        }
...
class __PRIVATE_SyncEngineImpl {
    constructor(e, t, n, i, s, o) {
        this.localStore = e, this.remoteStore = t, this.eventManager = n, this.sharedClientState = i, this.currentUser = s, this.maxConcurrentLimboResolutions = o, this.Va = {}, this.ma = new ObjectMap((e => __PRIVATE_canonifyQuery(e)), __PRIVATE_queryEquals), this.fa = new Map, this.ga = new Set, this.pa = new SortedMap(DocumentKey.comparator), this.ya = new Map, this.wa = new __PRIVATE_ReferenceSet, this.Sa = {}, this.ba = new Map, this.Da = __PRIVATE_TargetIdGenerator.Nn(), this.onlineState = "Unknown", this.Ca = void 0
    }
    get isPrimaryClient() {
        return !0 === this.Ca
    }
...
async function __PRIVATE_initializeViewAndComputeSnapshot(e, t, n, i, s) {
    e.va = (t, n, i) => async function __PRIVATE_applyDocChanges(e, t, n, i) {
        let s = t.view.ca(n);
        s.Zi && (s = await __PRIVATE_localStoreExecuteQuery(e.localStore, t.query, !1).then((({
            documents: e
        }) => t.view.ca(e, s))));
...
async function __PRIVATE_syncEngineUnlisten(e, t) {
    ...
    if (s.length > 1) return n.fa.set(i.targetId, s.filter((e => !__PRIVATE_queryEquals(e, t)))), void n.ma.delete(t);
...
async function __PRIVATE_syncEngineApplyRemoteEvent(e, t) {
    ...
    try {
        ...
        t.targetChanges.forEach(((e, t) => {
            const i = n.ya.get(t);
            i && (__PRIVATE_hardAssert(e.addedDocuments.size + e.modifiedDocuments.size + e.removedDocuments.size <= 1), e.addedDocuments.size > 0 ? i.Ra = !0 : e.modifiedDocuments.size > 0 ? __PRIVATE_hardAssert(i.Ra) : e.removedDocuments.size > 0 && (__PRIVATE_hardAssert(i.Ra), i.Ra = !1))
...
function __PRIVATE_syncEngineApplyOnlineStateChange(e, t, n) {
    ...
    if (i.isPrimaryClient && 0 === n || !i.isPrimaryClient && 1 === n) {
        ...
        i.ma.forEach(((n, i) => {
            ...
            }(i.eventManager, t), e.length && i.Va.a_(e), i.onlineState = t, i.isPrimaryClient && i.sharedClientState.setOnlineState(t)
    }
}
...
function __PRIVATE_updateTrackedLimbos(e, t, n) {
    for (const i of n) i instanceof __PRIVATE_AddedLimboDocument ? (e.wa.addReference(i.key, t), __PRIVATE_trackLimboChange(e, i)) : i instanceof __PRIVATE_RemovedLimboDocument ? (__PRIVATE_logDebug("SyncEngine", "Document no longer in limbo: " + i.key), e.wa.removeReference(i.key, t), e.wa.containsKey(i.key) || __PRIVATE_removeLimboTarget(e, i.key)) : fail()
}
...
function __PRIVATE_pumpEnqueuedLimboResolutions(e) {
    for (; e.ga.size > 0 && e.pa.size < e.maxConcurrentLimboResolutions;) {
        ...
        const n = new DocumentKey(ResourcePath.fromString(t)),
            i = e.Da.next();
        e.ya.set(i, new LimboResolution(n)), e.pa = e.pa.insert(n, i), __PRIVATE_remoteStoreListen(e.remoteStore, new TargetData(__PRIVATE_queryToTarget(__PRIVATE_newQueryForPath(n.path)), i, "TargetPurposeLimboResolution", __PRIVATE_ListenSequence._e))
    }
}
async function __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(e, t, n) {
    const i = __PRIVATE_debugCast(e),
        ...
        o = [],
        u = [];
    i.ma.isEmpty() || (i.ma.forEach(((e, l) => {
        u.push(i.va(l, t, n).then((e => {
    ...
    })), await Promise.all(u), i.Va.a_(s), await async function __PRIVATE_localStoreNotifyLocalViewChanges(e, t) {
        const n = __PRIVATE_debugCast(e);
        try {
            await n.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (e => PersistencePromise.forEach(t, (t => PersistencePromise.forEach(t.ki, (i => n.persistence.referenceDelegate.addReference(e, t.targetId, i))).next((() => PersistencePromise.forEach(t.qi, (i => n.persistence.referenceDelegate.removeReference(e, t.targetId, i)))))))))
        } catch (e) {
            if (!__PRIVATE_isIndexedDbTransactionError(e)) throw e;
...
async function __PRIVATE_syncEngineHandleCredentialChange(e, t) {
    ...
    if (!n.currentUser.isEqual(t)) {
        ...
        n.currentUser = t,
            ...
            }(n, "'waitForPendingWrites' promise is rejected due to a user change."), n.sharedClientState.handleUserChange(t, e.removedBatchIds, e.addedBatchIds), await __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(n, e._s)
    }
}
...
async function __PRIVATE_syncEngineApplyActiveTargetsChange(e, t, n) {
    ...
    if (i.Ca) {
        ...
        for (const e of n) i.fa.has(e) && await __PRIVATE_localStoreReleaseTarget(i.localStore, e, !1).then((() => {
...
class __PRIVATE_MultiTabOfflineComponentProvider extends __PRIVATE_IndexedDbOfflineComponentProvider {
    ...
    async initialize(e) {
        ...
        this.sharedClientState instanceof __PRIVATE_WebStorageSharedClientState && (this.sharedClientState.syncEngine = {
            ...
            }(this.xa.syncEngine, e), this.gcScheduler && (e && !this.gcScheduler.started ? this.gcScheduler.start() : e || this.gcScheduler.stop()), this.indexBackfillerScheduler && (e && !this.indexBackfillerScheduler.started ? this.indexBackfillerScheduler.start() : e || this.indexBackfillerScheduler.stop())
        }))
    }
    createSharedClientState(e) {
...
async function __PRIVATE_setOnlineComponentProvider(e, t) {
    ...
    await t.initialize(n, i), e.setCredentialChangeListener((e => __PRIVATE_remoteStoreHandleCredentialChange(t.remoteStore, e))), e.setAppCheckTokenChangeListener(((e, n) => __PRIVATE_remoteStoreHandleCredentialChange(t.remoteStore, n))), e._onlineComponents = t
}
        ...
        ! function __PRIVATE_syncEngineLoadBundle(e, t, n) {
            ...
            (async function __PRIVATE_loadBundleImpl(e, t, n) {
                try {
                    ...
                    return await __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(e, u.ra, void 0), await
                    ...
                    }(e.localStore, i), n._completeWith(u.progress), Promise.resolve(u.na)
                } catch (e) {
...
class __PRIVATE_AsyncQueueImpl {
    constructor() {
        this.Ja = Promise.resolve(), this.Ya = [], this.Za = !1, this.Xa = [], this.eu = null, this.tu = !1, this.nu = !1, this.ru = [], this.zo = new __PRIVATE_ExponentialBackoff(this, "async_queue_retry"), this.iu = () => {
            const e = getDocument();
            ...
            try {
                ...
                function __PRIVATE_localStoreWriteLocally(e, t) {
                    ...
                    return n.persistence.runTransaction("Locally write mutations", "readwrite", (e => {
                        let l = __PRIVATE_mutableDocumentMap(),
                            _ = __PRIVATE_documentKeySet();
                        return n.ss.getEntries(e, s).next((e => {
                            l = e, l.forEach(((e, t) => {
...
! function __PRIVATE_registerFirestore(n, i = !0) {
    ...
    }), "PUBLIC").setMultipleInstances(!0)), t(Le, "4.4.0", n), t(Le, "4.4.0", "esm2017")
}();
export {
